...
export const addNotebook = async (name) => {
  try {
    const response = await axios.post('https://tahaelallem.sandsculptor.keiken-digital.io:8080/api/notebooks', {
      title: name
    });
...
export const getNotebooks = async () => {
  try {
    const response = await axios.get('https://tahaelallem.sandsculptor.keiken-digital.io:8080/api/notebooks');
...
export const deleteNotebook = async (id) => {
  try {
    await axios.delete(`https://tahaelallem.sandsculptor.keiken-digital.io:8080/api/notebooks/${id}`);
  } catch (err) {
...
// Sort notebooks
export const sortNotebooks = async () => {
  try {
    await axios.(`https://tahaelallem.sandsculptor.keiken-digital.io:8080/api/notebooks`);
  } catch (err) {
    console.error("An API error has occurred while sorting the notebooks:", err);
  }
};
...
export const addNote = async (notebookId, title, content) => {
  try {
    const response = await axios.post(`https://tahaelallem.sandsculptor.keiken-digital.io:8080/api/notebooks/${notebookId}/notes`, {
      title: title,
      content: content
    });
...
export const getNotes = async (notebookId) => {
  try {
    const response = await axios.get(`https://tahaelallem.sandsculptor.keiken-digital.io:8080/api/notebooks/${notebookId}/notes`);
...
export const updateNote = async (id, title, content) => {
  try {
    const response = await axios.put(`https://tahaelallem.sandsculptor.keiken-digital.io:8080/api/notes/${id}`, {
      title: title,
      content: content
    });
...
export const deleteNote = async (id) => {
  try {
    await axios.delete(`https://tahaelallem.sandsculptor.keiken-digital.io:8080/api/notes/${id}`);
  } catch (err) {
